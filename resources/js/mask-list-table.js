...
$(function () {
  ...
  if (data_table.length) {
    ...
    // Set minimal row and header height for table cells
    $('#datatable').on('draw.dt', function() {
      $('#datatable tbody tr').css('height', '10px'); // Set a minimal row height
      $('#datatable tbody td').css({'padding-top': '3px', 'padding-bottom': '3px', 'height': '20px'}); // Reduce padding and set td height
      // Decrease width for 1st and last columns
      $('#datatable tbody td:first-child, #datatable thead th:first-child').css('width', '40px');
      $('#datatable tbody td:last-child, #datatable thead th:last-child').css('width', '80px');
      // Decrease table header height
      $('#datatable thead th').css({'padding-top': '3px', 'padding-bottom': '3px', 'height': '25px'});
    });
