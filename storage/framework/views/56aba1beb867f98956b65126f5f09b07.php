...
<form action="<?php echo e(route('messages.store-regular-message')); ?>" method="POST">
  <?php echo csrf_field(); ?>
  <div class="row g-6">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-floating form-floating-outline maskingOptions" style="display: none;">
        <select name="sender_id" disabled <?php if(old('masking_type') == 'Masking'): ?> required <?php endif; ?> class="select2 form-select form-select-lg senderIdMasking" data-allow-clear="true">
          <option value="">Select</option>
          <?php $__currentLoopData = $maskList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$mask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($mask->mask); ?>" <?php if(old('sender_id') == $mask->mask): ?> selected <?php endif; ?>><?php echo e($mask->mask); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="form-floating form-floating-outline mb-6">
      ...
      <?php $__errorArgs = ['recipient_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Messages\resources/views/message/regular-message.blade.php ENDPATH**/ ?>