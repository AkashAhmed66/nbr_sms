            ...
            <div class="row g-5">
              <div class="col-12 col-sm-6 col-lg-5">
                <div class="form-floating form-floating-outline">
                  <input type="datetime-local" value="<?php echo e(\Carbon\Carbon::now('Asia/Dhaka')->startOfDay()->format('Y-m-d\TH:i')); ?>" class="form-control dt-input" name="from_date"
              ...
              <div class="col-12 col-sm-6 col-lg-5">
                <div class="form-floating form-floating-outline">
                  <input type="datetime-local" value="<?php echo e(\Carbon\Carbon::now('Asia/Dhaka')->format('Y-m-d\TH:i')); ?>" class="form-control dt-input" name="to_date"
                    max="<?php echo e(\Carbon\Carbon::now('Asia/Dhaka')->format('Y-m-d\TH:i')); ?>">
                  <label>Date To</label>
                </div>
              </div>
...
$(document).ready(function () {
  var table = $('#users-table').DataTable({
        ...
        ajax: {
            url: '<?php echo e(url('/reports/inbox-report')); ?>',
            data: function (d) {
    ...
    $('#download-excel-inbox').on('click', function(e) {
      ...
      window.location.href = '<?php echo e(route('inbox-export')); ?>?' + formData;
    });
});
</script>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Reports\resources/views/inbox-list.blade.php ENDPATH**/ ?>