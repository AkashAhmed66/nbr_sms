  ...
  <div class="offcanvas-body mx-0 flex-grow-0 h-100">
    <form class="add-new-user pt-0" id="importPhonebookGroupForm" enctype="multipart/form-data">
      ...
      <!--<div class="form-floating form-floating-outline mb-5">
        ...
        <option value="<?php echo e($reseller->id); ?>"><?php echo e($reseller->reseller_name); ?></option>
...
<?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Phonebook\resources/views/group/import-file.blade.php ENDPATH**/ ?>