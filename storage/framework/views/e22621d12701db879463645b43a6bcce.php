            ...
            <div class="row g-5">
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <input type="hidden" name="report_type" value="2days_failed">
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <select id="add-user-1" name="user_id" class="select2 form-select dt-input">
                ...
                <div class="row align-items-end">
                  ...
                  <div class="col-lg-10 col-md-9 col-sm-8">
                    <div class="d-flex gap-2 justify-content-end">
                      ...
                      <a href="<?php echo e(url('/reports/last-2days-failed-sms-list')); ?>" class="btn btn-secondary me-sm-3 me-1 data-reset"><i
...
<script>
  $(document).ready(function () {
    ...
    var table = $('#users-table').DataTable({
      ...
      ajax: {
        url: '<?php echo e(url('/reports/last-2days-failed-sms-list')); ?>',
        data: function (d) {
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Reports\resources/views/last-2days-failed-sms-list.blade.php ENDPATH**/ ?>