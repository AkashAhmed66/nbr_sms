        ...
        <div class="form-floating form-floating-outline mb-5">
            <select id="add-user" name="user_id" class="select2 form-select" data-placeholder="Select User">
                ...
                <?php $__currentLoopData = $userLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userList): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <option value="<?php echo e($userList->id); ?>"><?php echo e($userList->name); ?> (<?php echo e($userList->username); ?>)</option>
...
<?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Transactions\resources/views/uwallet/create_uwallet.blade.php ENDPATH**/ ?>