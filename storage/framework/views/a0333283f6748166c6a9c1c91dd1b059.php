<?php $__env->startSection('title', ' API Information'); ?>
  ...
  <div class="container my-5">
    <div class="card shadow">
      ...
      <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/smsapi</p>

        <h6 class="fw-bold">Request Body:</h6>
        <pre class="bg-light p-3 border rounded">
{
    "api_key": "<?php echo e($api_key); ?>",
    "type": "text",
    "senderid": "<?php echo e($senderId); ?>",
    "msg": "Hello",
                  ...
                  <pre class="bg-danger text-white p-3 border rounded">
{
    ...
    "error_code": 1020
      ...
      <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>

          /api/v1/send-sms-status?message_id=633352757&api_key=<?php echo e($api_key); ?></p>
        <h5>OR</h5>
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/send-sms-status</p>
...
    ]
      ...
      <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/user-info?api_key=<?php echo e($api_key); ?></p>
        ...
        <pre class="bg-danger text-white p-3 border rounded">
{
  ...
  <?php if(auth()->user()->id_user_group == 2): ?>
  <div class="card-body mt-5">
        <h6 class="fw-bold">Customer Create API Endpoint  (POST METHOD):</h6>
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/user-create</p>
                  ...
                  <pre class="bg-danger text-white p-3 border rounded">
{
  ...
  <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/user-update/{customer id}</p>
                  ...
                  <pre class="bg-danger text-white p-3 border rounded">
{
    ...
    "error_code": 1015
      ...
      <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/balance?api_key=<?php echo e($api_key); ?></p>
        ...
        <pre class="bg-danger text-white p-3 border rounded">
{
    ...
    "error_code": 1003
      ...
      <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/v1/incoming-messages-list?api_key=<?php echo e($api_key); ?></p>
        ...
        <pre class="bg-danger text-white p-3 border rounded">
{
    ...
    "error_code": 1015
      ...
      <div class="card-body mt-5">
        ...
        <p class="text-muted"><?php echo e(request()->getSchemeAndHttpHost()); ?>/api/initiate-payment</p>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Smsconfig\resources/views/api_information/apinfo.blade.php ENDPATH**/ ?>