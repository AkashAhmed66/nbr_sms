            ...
            <div class="row g-5">
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <input type="hidden" name="report_type" value="archived">
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <select id="add-user-3" name="user_id" class="select2 form-select dt-input">
                ...
                <div class="row align-items-end">
                  ...
                  <div class="col-lg-10 col-md-9 col-sm-8">
                    <div class="d-flex gap-2 justify-content-end">
                      ...
                      <a href="<?php echo e(url('/reports/archived-sms')); ?>" class="btn btn-secondary me-sm-3 me-1 data-reset"><i
    ...
    <div class="modal-dialog modal-dialog-centered" style="max-height: 55vh; max-width: 650px;">
      <div class="modal-content" style="height: 40vh; border-radius: 12px; box-shadow: 0 15px 35px rgba(0,0,0,0.1); border: none;">
        <div class="modal-header" style="background: #696cff; color: white; border-radius: 12px 12px 0 0; border-bottom: none; padding: 20px 25px;">
          <h5 class="modal-title d-flex align-items-center text-white" id="messageModalLabel">
...
<script>
  $(document).ready(function() {
    ...
    var table = $('#users-table').DataTable({
      ...
      ajax: {
        url: '<?php echo e(url('/reports/archived-sms')); ?>',
        data: function(d) {
      ...
      columns: [
        ...
        <?php if(env("APP_TYPE") !== "Aggregator"): ?>
          ...
          {
            data: 'error_code', name: 'error_code', render: function(data) {
              return data ? data : 'NULL';
            }
          },
          {
            data: 'error_message', name: 'error_message', render: function(data) {
              return data ? data : 'NULL';
            }
          }
        <?php else: ?>
...
<?php echo $__env->make('layouts/layoutMaster', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Reports\resources/views/archived-sms.blade.php ENDPATH**/ ?>