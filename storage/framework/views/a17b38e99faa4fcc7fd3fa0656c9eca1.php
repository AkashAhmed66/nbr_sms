        ...
        <form class="add-new-user pt-0" id="addNewUserForm1">
          ...
          <div class="form-floating form-floating-outline mb-5">
            <select id="add-sms-mask" name="sms_mask" class="select2 form-select">
              <option value="">Select</option>
              <?php $__currentLoopData = $maskList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($mask->id); ?>"><?php echo e($mask->mask); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Users\resources/views/user/create.blade.php ENDPATH**/ ?>