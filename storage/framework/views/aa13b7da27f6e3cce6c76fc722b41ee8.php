...
<form action="<?php echo e(route('messages.store-dynamic-message')); ?>" method="POST" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
  <div class="row g-6">
    <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="form-floating form-floating-outline maskingOptions" style="display: none;">
        <select name="sender_id" disabled <?php if(old('masking_type') == 'Masking'): ?> required <?php endif; ?>
...
</script><?php /**PATH C:\xampp\htdocs\metronetsms\Modules/Messages\resources/views/message/dynamic-message-actual.blade.php ENDPATH**/ ?>