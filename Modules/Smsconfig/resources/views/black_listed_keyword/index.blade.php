...
<!-- Modules/Smsconfig/resources/views/black_listed_keyword/index.blade.php -->
@section('page-script')
  <script>
  ...
  @vite(['resources/js/list-table.js', 'resources/js/keyword-management.js'])
@endsection
...
@section('content')
  <div class="card">
    ...
    @include('smsconfig::black_listed_keyword.create')
  </div>
@endsection
