  ...
  <div class="card mb-4">
    <div class="card-header">
      <div class="d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Campaign ID: {{ $campaignId }}</h5>
        <a href="{{ route('running-campaign-list') }}" class="btn btn-outline-secondary">
    ...
    <div class="card-body pt-2 pb-0">
      ...
      <form class="dt_adv_search mb-3">
        <div class="row g-3">
          ...
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="form-floating form-floating-outline mb-2">
              <input type="datetime-local" class="form-control dt-input" name="from_date" value="{{ \Carbon\Carbon::now('Asia/Dhaka')->subDays(2)->startOfDay()->format('Y-m-d\TH:i') }}" max="{{ \Carbon\Carbon::now('Asia/Dhaka')->format('Y-m-d\TH:i') }}">
              <label>Date From</label>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-3">
            <div class="form-floating form-floating-outline mb-2">
              <input type="datetime-local" class="form-control dt-input" name="to_date" value="{{ \Carbon\Carbon::now('Asia/Dhaka')->format('Y-m-d\TH:i') }}" max="{{ \Carbon\Carbon::now('Asia/Dhaka')->format('Y-m-d\TH:i') }}">
              <label>Date To</label>
            </div>
          </div>
          <div class="col-12 col-sm-6 col-lg-3">
          ...
          <div class="col-12 col-lg-3 d-flex align-items-end gap-2">
            ...
            <a href="{{ url()->current() }}" class="btn btn-secondary"><i class="ri ri-refresh-line"></i> Reset</a>
