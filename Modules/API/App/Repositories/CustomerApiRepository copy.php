...
class CustomerApiRepository implements CustomerApiRepositoryInterface
{
  ...
  public function sendMessage($request, $userInfo)
  {
    try {
      ...
      $apiResponse = $this->saveToOutbox($phoneNumbersString, $message, $request->senderid, $smsInfo->count, $userInfo->id, $sendMessage->id, $isMasking, $isUnicode);
  ...
  public function saveToOutbox($recipients, $message, $senderID, $totalMessage, $userId, $sendMessageId, $isMasking, $isUnicode)
  {
