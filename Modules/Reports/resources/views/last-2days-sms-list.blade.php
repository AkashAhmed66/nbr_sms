...
@section('content')
          ...
          <div class="row align-items-end">
            ...
            <div class="col-lg-10 col-md-9 col-sm-8">
              <div class="d-flex gap-2 justify-content-end">
                ...
                <a href="{{ url('/reports/last-2days-sms-list') }}" class="btn btn-secondary me-sm-3 me-1 data-reset"><i
  ...
  <script>
    ...
    const poll = setInterval(async () => {
      try {
      const res = await fetch(`{{ url('/exports') }}/${exportId}`, {
...
<script>
  $(document).ready(function () {
    ...
    var table = $('#users-table').DataTable({
      ...
      ajax: {
        url: '{{ url('/reports/last-2days-sms-list') }}',
        data: function (d) {
