              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <input type="datetime-local" class="form-control dt-input" name="from_date"
                    value="{{ \Carbon\Carbon::now('Asia/Dhaka')->subDays(4)->startOfDay()->format('Y-m-d\TH:i') }}"
              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <input type="datetime-local" class="form-control dt-input" name="to_date"
                    value="{{ \Carbon\Carbon::now('Asia/Dhaka')->subDays(2)->format('Y-m-d\TH:i') }}"
                    max="{{ \Carbon\Carbon::now('Asia/Dhaka')->format('Y-m-d\TH:i') }}">
                  <label>Date To</label>
                </div>
              </div>
                ...
                <div class="row align-items-end">
                  ...
                  <div class="col-lg-10 col-md-9 col-sm-8">
                    <div class="d-flex gap-2 justify-content-end">
                      ...
                      <a href="{{ url('/reports/failed-archived-sms') }}" class="btn btn-secondary me-sm-3 me-1 data-reset"><i
...
*/
      ajax: {
        url: '{{ url('/reports/failed-archived-sms') }}',
        data: function (d) {
    ...
    //   window.location.href = '{{ route('archived-sms-report-export') }}?' + formData;
    // });
