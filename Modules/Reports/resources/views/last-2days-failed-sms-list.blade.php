              ...
              <div class="col-12 col-sm-6 col-lg-3">
                <div class="form-floating form-floating-outline">
                  <input type="datetime-local" class="form-control dt-input" name="from_date"
                    value="{{ \Carbon\Carbon::now('Asia/Dhaka')->subDays(2)->startOfDay()->format('Y-m-d\TH:i') }}"
                ...
                <div class="row align-items-end">
                  ...
                  <div class="col-lg-10 col-md-9 col-sm-8">
                    <div class="d-flex gap-2 justify-content-end">
                      ...
                      <a href="{{ url('/reports/last-2days-failed-sms-list') }}" class="btn btn-secondary me-sm-3 me-1 data-reset"><i
...
<script>
  $(document).ready(function () {
    ...
    var table = $('#users-table').DataTable({
      ...
      ajax: {
        url: '{{ url('/reports/last-2days-failed-sms-list') }}',
        data: function (d) {
