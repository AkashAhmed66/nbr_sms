      ...
      <div class="card mb-6">
        ...
        @endif
          ...
          <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
              <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#form-tabs-regular-message" role="tab" aria-selected="true">
                <span class="ri-user-line ri-20px d-sm-none"></span><span class="d-none d-sm-block">Regular Message</span></button>
            </li>
            <li class="nav-item">
              <button class="nav-link " data-bs-toggle="tab" data-bs-target="#form-tabs-dynamic-message" role="tab" aria-selected="false"><span class="ri-folder-user-line ri-20px d-sm-none"></span><span class="d-none d-sm-block">Group Message</span></button>
            </li>
            <li class="nav-item">
              <button class="nav-link" data-bs-toggle="tab" data-bs-target="#form-tabs-file-message" role="tab" aria-selected="false"><span class="ri-facebook-fill ri-20px d-sm-none"></span><span class="d-none d-sm-block">File Message</span></button>
            </li>
          </ul>
        </div>
    ...
    <div class="col-xl">
      <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
          ...
          <span>Available Balance : 188,826.40 BDT</span>
