<form action="{{ route('messages.store-regular-message') }}" method="POST">
  ...
  <div class="row g-6">
    ...
    <div class="form-floating form-floating-outline mb-6">
      <textarea class="form-control h-px-100" id="number" name="recipient_number" placeholder="Number here..."></textarea>
      <label for="exampleFormControlTextarea1">Recipient Number</label>
